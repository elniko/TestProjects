...
public interface UserService extends UserDetailsService {
    ...
    public int addUserWithRole(String name, String pass, String mail, String role) throws RoleNotExistException, UserAlreadyExistException, RoleNotExistException, UserAlreadyExistException;

    public boolean removeUsers(int id) throws EntityNotExistsException;

    public boolean removeNotAdmins(int id) throws EntityNotExistsException, EntityNotExistsException;
    ...
    public ProfileEntity getActiveProfile(String userName) throws BadProfileException, UserNotExistsException, UserNotExistsException, BadProfileException;
